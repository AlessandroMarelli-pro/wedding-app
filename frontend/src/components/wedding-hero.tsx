...
export const WeddingHero = ({
  ...
  >
    <div className="relative grid grid-rows-3  grid-cols-1 xl:grid-rows-1 xl:grid-cols-6  items-center justify-center h-full w-full ">
      <p className="text-[#F38181] fraunces-regular row-span-1 xl:col-span-1  text-2xl xl:mb-2 font-light  h-full w-full flex flex-col text-center xl:text-left justify-center xl:justify-end pb-10">
