...
export default function FileUpload({
  ...
  return (
    ...
    >
      <div className="group relative w-full rounded-xl bg-white dark:bg-foreground ring-1 ring-gray-200 dark:ring-white/10 p-0.5">
        ...
        <div className="relative w-full rounded-[10px] bg-gray-50/50 dark:bg-white/[0.02] p-1.5">
          <div
            className={cn(
              'relative mx-auto w-full overflow-hidden rounded-lg border border-gray-100 dark:border-white/[0.08] bg-white dark:bg-foreground/50',
                ...
                {status === 'idle' || status === 'dragging' ? (
                  ...
                  >
                    ...
                    <button
                      ...
                      className=" flex items-center justify-center gap-2 rounded-lg bg-gray-100 dark:bg-white/10 px-4 py-2.5 text-sm font-semibold text-gray-900 dark:text-white transition-all duration-200 hover:bg-gray-200 dark:hover:bg-white/20 group"
                    >
                    ...
                    <p className="mt-3 text-xs text-gray-500 dark:text-gray-400">
                      ou drag & drop votre fichier ici
                    </p>
