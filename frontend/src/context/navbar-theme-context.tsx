...
const defaultNavbarTheme: NavbarTheme = {
  ...
  mobileNavItemsBg: 'oklch(0.6775 0.1304 20.48)',
  mobileNavCloseItemsBg: 'oklch(0.9581 0.0383 80.03)',
...
export const navbarThemes = {
  ...
  transparent: {
    ...
    hideNavbar: true,
    mobileNavItemsBg: 'oklch(0.9581 0.0383 80.03)',
    mobileNavCloseItemsBg: 'oklch(0.6775 0.1304 20.48)',
